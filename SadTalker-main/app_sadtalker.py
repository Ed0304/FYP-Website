...
SADTALKER_RESULTS_DIR = os.path.abspath("D:/Code/SadTalker-main/results")  # Update this if needed
FLASK_STATIC_VIDEOS = os.path.abspath("D:/SIM/MATERIALS/YEAR 3 (UOW)/CSIT321-Final Year Project/Application/FYP-25-S1-09 Mongodb Voice Generate/FYP25S109/static/uploads/videos")
...
def generate_talking_video(image_path, audio_path, preprocess_type, is_still_mode, enhancer, batch_size, size_of_image, pose_style):
    try:
        ...
        # You can add any audio/image validation here if needed
        ...
        return f"❌ Internal error: {repr(e)}"
